<template>
  <div style="width:50% ;margin: 40px auto ;min-height: 500px">
    <div style="display: flex;align-items:center;border-bottom: 1px solid #888888" v-for="item in data.cinemaData">
