      ...
      <div style="margin-top: 20px">
        <el-row :gutter="15">
          <el-col :span="6" v-for="item in data.playingData" style="margin-bottom: 20px">
            <img :src="item.img" alt="" style="width: 100%; height: 230px; border-top-left-radius: 5px; border-top-right-radius: 5px">
      ...
      <div style="margin-top: 20px">
        <el-row :gutter="15">
          <el-col :span="6" v-for="item in data.noPlayData" style="margin-bottom: 20px; cursor: pointer" @click="navTo('/front/filmDetail?id=' + item.id)">
            <img :src="item.img" alt="" style="width: 100%; height: 230px; border-radius: 5px; border-top-right-radius: 5px">
    ...
    <div style="width: 300px; margin-left: 50px">
      ...
      <div style="margin-top: 20px; border: 1px solid #dddddd; padding: 20px; border-radius: 5px">
        <div style="display: flex; grid-gap: 20px; margin-bottom: 20px">
          <img :src="data.firstTotal.img" alt="" style="width: 80px; height: auto;border-radius: 5px">
      ...
      <div style="margin-top: 50px; display: flex; grid-gap: 20px; align-items: center; background-color: #efefef;border-radius: 10px">
        <div style="background-color: red; font-size: 18px; text-align: center; color: white; width: 40px; padding: 10px;border-radius: 10px">今日票房</div>
        <div style="flex: 1">
      ...
      <div style="margin-top: 20px; border: 1px solid #dddddd; padding: 20px; border-radius: 5px">
        <div style="display: flex; grid-gap: 20px; margin-bottom: 20px">
          <img :src="data.firstScore.img" alt="" style="width: 80px; height: auto;border-radius: 5px">
          <div style="flex: 1; width: 0">
